  ...
  <table class="form-table">
    <tr valign="top">
      ...
      <td>
        ...
        <span class="plscptf_info" style="font-family: sans-serif; font-size: 12px; font-style: italic; color: white; display: table; padding-left: 20px;"><?php _e("Which of your Wordpress users do you want to receive<br> the messages from the PlusCaptcha contact form?", 'PlusCaptcha'); ?></span>
      </td>
    </tr>
    <tr valign="top">
      ...
      <td>
        ...
        <span class="plscptf_info" style="font-family: sans-serif; font-size: 12px; font-style: italic; color: white; display: table; padding-left: 20px;"><?php _e("Or, provide a custom email address here. <br>This email address will receive all messages...", 'PlusCaptcha'); ?></span>
      </td>
    </tr>
    <tr valign="top">
...
<table style="background-color: white; width: 100%; margin-top: 10px; color: #666666;" class="plscptf_additions_block plscptf_hidden">
    <tr valign="top" class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <th scope="row"><?php _e("Show the &#34send me a copy&#34 option:", 'PlusCaptcha'); ?></th>
      <td colspan="2">
    ...
    <tr class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <th rowspan="2"><?php _e('Specify whicih email function you wish to use:', 'PlusCaptcha'); ?></th>
      <td>
      ...
      <td>
        ...
        <span  class="plscptf_info">(<?php _e('The WordPress WP_Mail function', 'mail_send'); ?>)</span>
      </td>
    </tr>
    <tr class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <td>
      ...
      <td>
        ...
        <span  class="plscptf_info">(<?php _e('The PHP mail function', 'mail_send'); ?>)</span>
      </td>
    </tr>
    <tr valign="top" class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <th scope="row"><?php _e("Customize the FROM field of the contact form:", 'PlusCaptcha'); ?></th>
      <td colspan="2">
    ...
    <tr valign="top" class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <th scope="row"><?php _e("Display additional information in the email:", 'PlusCaptcha'); ?></th>
      <td>
    ...
    <tr valign="top" class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <th scope="row"><?php _e("Change labels for fields in the contact form:", 'PlusCaptcha'); ?></th>
      <td>
    ...
    <tr valign="top" class="plscptf_additions_block <?php if ($plscptf_options['plscptf_additions_options'] == '0') echo "plscptf_hidden"; ?>">
      <th scope="row"><?php _e("What to do after the message is sent:", 'PlusCaptcha'); ?></th>
